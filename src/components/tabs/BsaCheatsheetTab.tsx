...
const sidebarGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "bsa-gen-12", label: "Complex business process" },
      { id: "bsa-gen-13", label: "Prioritize requirements" },
      { id: "bsa-gen-14", label: "BI tools experience" },
      { id: "bsa-gen-15", label: "Conflicting priorities" },
      { id: "bsa-gen-16", label: "Data analysis approach" },
      { id: "bsa-gen-17", label: "Successful UAT" },
      { id: "bsa-gen-18", label: "Communicating to non-tech" },
      { id: "bsa-gen-19", label: "Industry trends" },
      { id: "bsa-gen-20", label: "Agile methodologies" },
      { id: "bsa-gen-21", label: "Gathering & documenting reqs" },
      { id: "bsa-gen-22", label: "Process improvement" },
      { id: "bsa-gen-23", label: "Schedule & budget" },
      { id: "bsa-gen-24", label: "Data-driven improvement" },
      { id: "bsa-gen-25", label: "Scope changes" },
      { id: "bsa-gen-26", label: "Technical documentation" },
      { id: "bsa-gen-27", label: "Risk management" },
      { id: "bsa-gen-28", label: "BSA analysis reports" },
      { id: "bsa-gen-29", label: "Essential BSA tools" },
      { id: "bsa-gen-30", label: "System scalability" },
      { id: "bsa-gen-31", label: "BRD vs SRS" },
      { id: "bsa-gen-32", label: "Business-tech communication" },
      { id: "bsa-gen-33", label: "Requirement prioritization" },
      { id: "bsa-gen-34", label: "Mediating conflicts" },
      { id: "bsa-gen-35", label: "Testing & QA approach" },
      { id: "bsa-gen-36", label: "Successful project example" },
    ],
  },
  {

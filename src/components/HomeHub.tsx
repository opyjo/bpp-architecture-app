...
const TAB_DESCRIPTIONS: Record<string, string> = {
  ...
  adejoke: "City of Hamilton senior project manager interview studio",
  ...
  "canadian-tire": "Canadian Tire front-end practice manager interview command center",
  mastercard: "Mastercard Business Identity Manager, Product Management (Technical) interview prep",

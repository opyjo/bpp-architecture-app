...
export default function ArchitectureSvg({ activeStep, onNodeClick }: ArchitectureSvgProps) {
  ...
  return (
    ...
    >
      ...
      <text x={34} y={26} fontSize={9.5} fill="var(--arch-text3)" fontWeight={500} letterSpacing="0.09em">CUSTOMER BROWSER / HOST SHELL APP</text>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-ui") }} onClick={() => onNodeClick("ui")}>
        ...
        <text x={410} y={50} textAnchor="middle" fontSize={12.5} fontWeight={600} fill="var(--arch-purple)">Subscription Manager UI</text>
        <text x={410} y={67} textAnchor="middle" fontSize={10.5} fill="var(--arch-purple)">Next.js 14 · React 18 · Module Federation · /customer/* /agent</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-bff") }} onClick={() => onNodeClick("bff")}>
        ...
        <text x={410} y={156} textAnchor="middle" fontSize={12.5} fontWeight={600} fill="var(--arch-teal)">Next.js BFF — /api/protected/*</text>
        <text x={410} y={172} textAnchor="middle" fontSize={10.5} fill="var(--arch-teal)">Validates session · obtains OAuth2 token · proxies calls</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-auth") }} onClick={() => onNodeClick("auth")}>
        ...
        <text x={714} y={172} textAnchor="middle" fontSize={10.5} fill="var(--arch-coral)">OAuth2 / Cognito / Auth0</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-appsync") }} onClick={() => onNodeClick("appsync")}>
        ...
        <text x={195} y={258} textAnchor="middle" fontSize={12.5} fontWeight={600} fill="var(--arch-blue)">AWS AppSync</text>
        <text x={195} y={274} textAnchor="middle" fontSize={10.5} fill="var(--arch-blue)">GraphQL gateway · all mutations</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-agg") }} onClick={() => onNodeClick("agg")}>
        ...
        <text x={635} y={258} textAnchor="middle" fontSize={12.5} fontWeight={600} fill="var(--arch-blue)">subscriptions-aggregator-api</text>
        <text x={635} y={274} textAnchor="middle" fontSize={10.5} fill="var(--arch-blue)">{"REST read-only · active & past subs"}</text>
      </g>
      ...
      <text x={34} y={350} fontSize={9.5} fill="var(--arch-text3)" fontWeight={500} letterSpacing="0.09em">GO MICROSERVICES — go-repo-new</text>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-reseller") }} onClick={() => onNodeClick("reseller")}>
        ...
        <text x={148} y={396} textAnchor="middle" fontSize={10} fill="var(--arch-amber)">Subscription CRUD · PostgreSQL</text>
        <text x={148} y={410} textAnchor="middle" fontSize={9.5} fill="var(--arch-text3)">Gin + OpenAPI · Kafka publisher</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-catalog") }} onClick={() => onNodeClick("catalog")}>
        ...
        <text x={410} y={396} textAnchor="middle" fontSize={10} fill="var(--arch-amber)">{"Offers & plans · Redis cache"}</text>
        <text x={410} y={410} textAnchor="middle" fontSize={9.5} fill="var(--arch-text3)">GraphQL (gqlgen)</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-session") }} onClick={() => onNodeClick("session")}>
        ...
        <text x={672} y={396} textAnchor="middle" fontSize={10} fill="var(--arch-amber)">Session lifecycle · DynamoDB</text>
        <text x={672} y={410} textAnchor="middle" fontSize={9.5} fill="var(--arch-text3)">generateSession · cloneSession</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-household") }} onClick={() => onNodeClick("household")}>
        ...
        <text x={148} y={498} textAnchor="middle" fontSize={10} fill="var(--arch-green)">{"Account & equipment · CPM"}</text>
        <text x={148} y={512} textAnchor="middle" fontSize={9.5} fill="var(--arch-text3)">GraphQL (gqlgen)</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-token") }} onClick={() => onNodeClick("token")}>
        ...
        <text x={410} y={498} textAnchor="middle" fontSize={10} fill="var(--arch-green)">Payload tokenization · Redis</text>
        <text x={410} y={512} textAnchor="middle" fontSize={9.5} fill="var(--arch-text3)">24h TTL · mid-flow state</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-audit") }} onClick={() => onNodeClick("audit")}>
        ...
        <text x={672} y={498} textAnchor="middle" fontSize={10} fill="var(--arch-green)">Event logging · PostgreSQL</text>
        <text x={672} y={512} textAnchor="middle" fontSize={9.5} fill="var(--arch-text3)">Orders · activations · recovery</text>
      </g>

      {/* Merchant APIs box */}
      <rect x={38} y={556} width={764} height={96} rx={8} fill="none" stroke="var(--arch-border2)" strokeWidth={0.5} strokeDasharray="3 3" />
      <text x={50} y={570} fontSize={9.5} fill="var(--arch-text3)" fontWeight={500} letterSpacing="0.06em">MERCHANT APIs — transparent to UI · invoked by reseller-service only</text>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-bango") }} onClick={() => onNodeClick("bango")}>
        ...
        <text x={113} y={601} textAnchor="middle" fontSize={10.5} fontWeight={600} fill="var(--arch-gray)">merchant-api</text>
        <text x={113} y={615} textAnchor="middle" fontSize={10} fontWeight={600} fill="var(--arch-gray)">bango-v1</text>
        <text x={113} y={629} textAnchor="middle" fontSize={9.5} fill="var(--arch-text3)">platform aggregator</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-netflix") }} onClick={() => onNodeClick("netflix")}>
        ...
        <text x={261} y={601} textAnchor="middle" fontSize={10.5} fontWeight={600} fill="var(--arch-gray)">merchant-api</text>
        <text x={261} y={615} textAnchor="middle" fontSize={10} fontWeight={600} fill="var(--arch-gray)">netflix</text>
        <text x={261} y={629} textAnchor="middle" fontSize={9.5} fill="var(--arch-text3)">streaming</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-disney") }} onClick={() => onNodeClick("disney")}>
        ...
        <text x={409} y={601} textAnchor="middle" fontSize={10.5} fontWeight={600} fill="var(--arch-gray)">merchant-api</text>
        <text x={409} y={615} textAnchor="middle" fontSize={10} fontWeight={600} fill="var(--arch-gray)">disney</text>
        <text x={409} y={629} textAnchor="middle" fontSize={9.5} fill="var(--arch-text3)">streaming</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-bellmedia") }} onClick={() => onNodeClick("bellmedia")}>
        ...
        <text x={565} y={601} textAnchor="middle" fontSize={10.5} fontWeight={600} fill="var(--arch-gray)">merchant-api</text>
        <text x={565} y={615} textAnchor="middle" fontSize={10} fontWeight={600} fill="var(--arch-gray)">bellmedia</text>
        <text x={565} y={629} textAnchor="middle" fontSize={9.5} fill="var(--arch-text3)">content</text>
      </g>
      ...
      <g style={{ cursor: "pointer", opacity: nodeOpacity("n-radiocan") }} onClick={() => onNodeClick("radiocan")}>
        ...
        <text x={725} y={601} textAnchor="middle" fontSize={10.5} fontWeight={600} fill="var(--arch-gray)">merchant-api</text>
        <text x={725} y={615} textAnchor="middle" fontSize={10} fontWeight={600} fill="var(--arch-gray)">radiocanada</text>
        <text x={725} y={629} textAnchor="middle" fontSize={9.5} fill="var(--arch-text3)">content</text>
      </g>
